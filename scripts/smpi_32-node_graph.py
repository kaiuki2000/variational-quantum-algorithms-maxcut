# Infinite 'shots' number. Unless explecitly stated otherwise, the 'shots' number is set to 'None', always.
...
if __name__ == "__main__":
    ...
    # Right now, this runs with an infinite number of 'shots' (shots = None).
    # In the future, though, I want to compare these results to the ones obtained with a finite number of 'shots'.
    # E.g., shots = 256, 512, 1024, etc. (Or, shots = 100, 500, 1000, etc.).
    ...
    qemc_ar_vec, qemc_med_bsf_vec, qemc_avg_bsf_vec, qemc_bsf_avg_vec, qemc_avg_vec, \
        ...
        avg_best_so_far(vqa_graph_instance, vqa = 'qemc', n_qubits = n_qubits_qemc, n_layers = n_layers_qemc, device = 'default.qubit',
                        shots = None,
    ...
    smpi_sel_iqaqe_ar_vec, smpi_sel_iqaqe_med_bsf_vec, smpi_sel_iqaqe_avg_bsf_vec, smpi_sel_iqaqe_bsf_avg_vec, smpi_sel_iqaqe_avg_vec, \
        ...
        avg_best_so_far(vqa_graph_instance, vqa = 'smpi_iqaqe', n_qubits = n_qubits, n_layers = d['SEL'][1], device = 'default.qubit',
                        ansatz_type = 'SEL', cost_type = 'iQAQE', encoding = generate_polynomial_encoding(vqa_graph_instance, k = 3), B = None, rs = None, diff_Rx = False,
                        max_iter = 100, draw_plot = False, shots = None,
    ...
    smpi_brickwork_iqaqe_ar_vec, smpi_brickwork_iqaqe_med_bsf_vec, smpi_brickwork_iqaqe_avg_bsf_vec, smpi_brickwork_iqaqe_bsf_avg_vec, smpi_brickwork_iqaqe_avg_vec, \
        ...
        avg_best_so_far(vqa_graph_instance, vqa = 'smpi_iqaqe', n_qubits = n_qubits, n_layers = d['Brickwork'][1], device = 'default.qubit',
    ...
    smpi_parity_iqaqe_ar_vec, smpi_parity_iqaqe_med_bsf_vec, smpi_parity_iqaqe_avg_bsf_vec, smpi_parity_iqaqe_bsf_avg_vec, smpi_parity_iqaqe_avg_vec, \
        ...
        avg_best_so_far(vqa_graph_instance, vqa = 'smpi_iqaqe', n_qubits = n_qubits, n_layers = d['Parity'][1], device = 'default.qubit',
                        ansatz_type = 'Parity', cost_type = 'iQAQE', encoding = generate_polynomial_encoding(vqa_graph_instance, k = 3), B = None, rs = None, diff_Rx = True, # Different Rx gates for the Parity ansatz.
                        max_iter = 100, draw_plot = False, shots = None,
                        repeat = 3,
                        MaxCut = 1., step_size = 0.99); print()
    ...
    smpi_parity_expectation_ar_vec, smpi_parity_expectation_med_bsf_vec, smpi_parity_expectation_avg_bsf_vec, smpi_parity_expectation_bsf_avg_vec, smpi_parity_expectation_avg_vec, \
        ...
        avg_best_so_far(vqa_graph_instance, vqa = 'smpi_iqaqe', n_qubits = n_qubits, n_layers = d['Parity'][1], device = 'default.qubit',
                        ansatz_type = 'Parity', cost_type = 'Expectation', encoding = generate_polynomial_encoding(vqa_graph_instance, k = 3), B = None, rs = None, diff_Rx = True, # Different Rx gates for the Parity ansatz.
                        max_iter = 100, draw_plot = False, shots = None,
                        repeat = 3,
                        MaxCut = 1., step_size = 0.99); print()
    # goemans_williamson
    ...
    ax.set_title(r'smpi: Cost, ansätze variations (shots = None, $32$-node graph, k = 3):'
                '\n'
    ...
    plt.savefig('smpi_32-node_graph_k3_r10_med_bsf.png', dpi = 600, bbox_inches = 'tight')
    print("[Info.] The plot has been saved as 'smpi_32-node_graph_k3_r10_med_bsf.png'.")
    ...
    np.save('smpi_32-node_graph_k3_r10_results.npy', smpi_results)
    print("[Info.] The 'smpi' results have been saved as 'smpi_32-node_graph_k3_r10_results.npy'.")

    # Read the 'smpi' results
    smpi_results = np.load('smpi_32-node_graph_k3_r10_results.npy', allow_pickle=True).item()
    print("[Info.] The 'smpi' results have been read from 'smpi_32-node_graph_k3_r10_results.npy'.")
